...
The Broker class is the context that maintains a reference to a SortingStrategy object. It has a setStrategy() method to set the strategy and a sortArray() method that delegates the sorting behavior to the strategy. */
